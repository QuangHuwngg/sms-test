try:
    ...
    BBot(phone, amount)
                ...
                _______   _______               _____   _  __    _____     ____    _   _   ______   _ 
        /\     |__   __| |__   __|     /\      / ____| | |/ /   |  __ \   / __ \  | \ | | |  ____| | |
        /  \       | |       | |       /  \    | |      | ' /    | |  | | | |  | | |  \| | | |__    | |
    / /\ \      | |       | |      / /\ \   | |      |  <     | |  | | | |  | | | . ` | |  __|   | |
    / ____ \     | |       | |     / ____ \  | |____  | . \    | |__| | | |__| | | |\  | | |____  |_|
    /_/    \_\    |_|       |_|    /_/    \_\  \_____| |_|\_\   |_____/   \____/  |_| \_| |______| (_)'''
    print(Colorate.Vertical(Colors.DynamicMIX((Col.light_blue, Col.light_gray)), Center.XCenter(done)))
except:
    os.system("cls" if os.name == "nt" else "clear")
    print("[+] Một số tài nguyên không tồn tại, Đang cài đặt!")
    os.system("pip install threaded")
    os.system("pip install ThreadPoolExecutorPlus")
